...
socket.commands((data) => {
  ...
  async function setupUser(name) {
    ...
    if (userData.error === null || LocalNameData === cache['LocalNameData'] || LocalNameData === `Kiana`) {
        userData = {
            "id": `Kiana`,
            "statistics": {
    ...
    if (cache['ColorSet'] === `API`) {
        if (userData.error === null || LocalNameData === cache['LocalNameData'] || LocalNameData === `Kiana` || userData.id === `Kiana`) {
            avatarColor = {
                "hsl1": [
                    0.5277777777777778,
                    0
